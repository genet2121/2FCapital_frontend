...
function FilterWindow({ form, conditions, filter, closeWindow }: {
    ...
    return (
        <div className="card rounded shadow-sm" style={wstyle}>
            ...
            <div className="card-body" style={{ height: "100%", overflow: "auto" }}>
                <div className="mb-3 d-flex justify-content-start">
                    ...
                    <button disabled={selectedColumn == ""} className="btn btn-sm btn-primary" style={{ width: "max-content" }} onClick={setColumn}>
                ...
                {
                    fields.map(field => {
                        if (!field.visible || !conditionFilter[field.id]) {
                            return <></>;
                        } else {
            ...
            <div className="card-footer d-flex justify-content-end">
                <button className="btn btn-sm btn-primary" style={{ width: "max-content" }} onClick={() => { filter(conditionFilter); }}>
